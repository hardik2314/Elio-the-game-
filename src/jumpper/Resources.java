...
public class Resources {
    ...
    public static void load() {
        try {
            ...
            Resources.jumpAudio = Applet.newAudioClip(Resources.class.getClassLoader().getResource("jumpper/images/onjump.wav"));
            Resources.hitAudio = Applet.newAudioClip(Resources.class.getClassLoader().getResource("jumpper/images/hit.wav"));
